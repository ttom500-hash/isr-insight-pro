...
st.markdown(f"""
    ...
    .scroll-text {{ display: inline-block; padding-right: 100%; animation: tScroll 60s linear infinite; font-family: sans-serif; font-size: 0.9rem; white-space: nowrap; color: #f1f5f9 !important; }}
